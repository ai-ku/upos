...
\author{
Mehmet Ali Yatbaz\thanks{Artificial Intelligence Laboratory, Ko\c{c} University, 34450 Sar{\i}yer, \.Istanbul, Turkey. E-mail: myatbaz@ku.edu.tr}
}
\affil{Ko\c{c} University}

\author{
Enis Sert\thanks{Artificial Intelligence Laboratory, Ko\c{c} University, 34450 Sar{\i}yer, \.Istanbul, Turkey. E-mail: esert@ku.edu.tr}
}
\affil{Ko\c{c} University}

\author{
Deniz Yuret\thanks{Artificial Intelligence Laboratory, Ko\c{c} University, 34450 Sar{\i}yer, \.Istanbul, Turkey. E-mail: dyuret@ku.edu.tr}
}
\affil{Ko\c{c} University}
