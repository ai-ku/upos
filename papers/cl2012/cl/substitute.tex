...
In this section we determine the best usage of substitute vectors
within the context clustering framework by comparing similarity
metrics together with dimension reduction and clustering methods
without using the word identities or any other features.  In the
following section, we describe the theory and computation of
