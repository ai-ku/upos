...
without using the word identities or any features other than the
substitute vectors.
...
In the following section, we describe the substitute vector theory and
...
the previous sections to the PTB.

In section~\ref{sec:code} and \ref{sec:feat}[??] we discuss the
co-occurance modeling as an alternative to VSM.
