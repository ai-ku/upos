...
\centering
\small
\caption{The table below represents the input sentence
  \textit{``Pierre Vinken, 61 years old, will join the board as a
    nonexecutive director Nov.~29 .''} as tuples of words, their
  substitutes and features.  Words on the left column presents the
...
W:, & \texit{C:,} & & &&&\\
W:61 & \texti{C:48} & & & {\it F:N}&&\\
W:years & \text{C:years} & {\it F:s} &&&&\\
W:old & \text{C:old} & & &&&\\
W:join & \textit{C:head} &&&&&\\
W:the & \textit{C:its} &&&&&\\
