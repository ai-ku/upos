...
Y^{(K)}$ stand for one morphological and various orthographic features
of the word.  With this setup, the training procedure needs to change
little: instead of sampling a word -- random-substitute pair, the
word -- substitute -- features tuple is sampled and input to the
