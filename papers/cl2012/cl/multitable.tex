...
%  \tiny
  ...
  \caption{The \mto\ and \vm\ scores on 19 corpora in 15 languages
    ...
    results represent the best (90\% confidence level)( \mto\ and
    \vm\ accuracies of the corresponding language.  MULTEXT-East
    corpora do not tag the punctuation marks, thus we add an extra tag
    for punctuation and represent it with ``+1''.}
  \begin{flushleft}
...
%        & Chinese    & 40,562  & 15 & -   & & & - & -           \\
        ...
        & Dutch      & 28,393  & 13   & .711$^\ddagger$ / .547$^\start$ & .6703 / .5205 & .6957 / .5331  & {\bf.7401} / {\bf.5986}     & .7210 / .5919 \\
