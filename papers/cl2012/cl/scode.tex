\section{Co-occurrence Data Embedding Theory}
\label{sec:code}
...
target word identity and features had limited success.
%\footnote{A
...
%  reduction methods give results inferior to this upper bound.} 
It is
...
introduced by \cite{maron2010sphere}.  In Section~\ref{sec:feat} we
